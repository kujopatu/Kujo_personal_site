    ...
    <div className="min-h-screen p-6 text-gray-800 font-sans">
        ...
        <div className="flex gap-2 mb-4">
          {["All", "Logistics", "Web"].map(cat => (
            <button
              ...
              className={`px-3 py-1 border rounded ${filter === cat ? "bg-orange-600 text-white" : "text-orange-600"}`}
            >
              {cat}
            </button>
          ))}
      ...
      <section className="mb-10">
        ...
        <blockquote className="italic border-l-4 pl-4 text-gray-600">
          "Kujo delivers excellent results with precision and care." – Happy Client
        </blockquote>
      </section>
